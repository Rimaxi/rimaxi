                    ...
                    <div class="col-md-8 ">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4>
                                    Add country
                                    <a href="{{ route('country.index') }}" class="'btn btn-danger btn-sm float-end">Back</a>
                                </h4>
                            </div>
                            <div class="card-body">
                                <form id="addcountry">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <input type="text" class="form-control" id="countryname" name="countryname" placeholder="Enter Country">
